...
export class Backend implements backendInterface {
    ...
    async submitRSVP(arg0: string, arg1: bigint, arg2: boolean, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateWeddingDetails(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateWeddingDetails(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
