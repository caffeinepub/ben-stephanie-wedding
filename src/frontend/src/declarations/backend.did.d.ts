...
export interface _SERVICE {
  ...
  'deleteRSVP' : ActorMethod<[bigint, string], undefined>,
  'getAllRSVPs' : ActorMethod<[string], Array<RSVP>>,
  'getWeddingDetails' : ActorMethod<[], WeddingDetails>,
  'submitRSVP' : ActorMethod<[string, bigint, boolean, string, string], bigint>,
}
